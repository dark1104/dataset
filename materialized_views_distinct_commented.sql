...
-- Distinct view for field: time_inserted_ns
...
-- Distinct view for field: time_received_ns
...
-- Distinct view for field: flow_start_time
...
-- Distinct view for field: flow_end_time
...
-- Distinct view for field: protocolIdentifier
...
-- Distinct view for field: protocolName
...
-- Distinct view for field: sourceIPv4Address
...
-- Distinct view for field: destinationIPv4Address
...
-- Distinct view for field: sourceTransportPort
...
-- Distinct view for field: destinationTransportPort
...
-- Distinct view for field: octetDeltaCount
...
-- Distinct view for field: packetDeltaCount
...
-- Distinct view for field: flowStartMilliseconds
...
-- Distinct view for field: flowEndMilliseconds
...
-- Distinct view for field: mac_source
...
-- Distinct view for field: mac_destination
...
-- Distinct view for field: application_name
...
-- Distinct view for field: http_url
...
-- Distinct view for field: https_url_certificate
...
-- Distinct view for field: datalink_vlan
...
-- Distinct view for field: bytes_accumulated
...
-- Distinct view for field: tcp_retransmits
...
-- Distinct view for field: tcp_rst
...
-- Distinct view for field: tcp_fin
...
-- Distinct view for field: bytes_per_packet
...
-- Distinct view for field: flow_duration_ms
...
-- Distinct view for field: flow_direction
...
-- Distinct view for field: profile_name
...
-- Distinct view for field: asn_number
...
-- Distinct view for field: asn_organization
...
-- Distinct view for field: city_name
...
-- Distinct view for field: country_name
...
-- Distinct view for field: latitude
...
-- Distinct view for field: longitude
...
-- Distinct view for field: iso_code
